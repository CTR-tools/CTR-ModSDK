...
void DECOMP_MainFreeze_ConfigSetupEntry()
{
			...
			if ((iVar9 & 0x800U) != 0)
	{
			...
			ot = (sdata_gGT->tileView_UI).ptrOT;
				...
				else
	{
			...
			MENUBOX_DrawRwdTriangle(local_48,(char *)data_raceConfig_colors_arrows,(u_long *)(sdata_gGT->tileView_UI).ptrOT,&sdata_gGT->backBuffer->primMem);
			iVar6 = iVar6 + 1;
		...
		MENUBOX_DrawRwdBlueRect(&local_38,(char *)data_raceConfig_colors_blueRect,(u_long *)(sdata_gGT->tileView_UI).ptrOT,&sdata_gGT->backBuffer->primMem);
		r = &local_30;
		local_30.x = -0x14;
		local_30.w = 0x228;
		local_30.h = 0x91;
...
LAB_800387c4:
		...
		do
	{
			...
			MainFreeze_ConfigDrawNPC105((short)(((uint)*(ushort *)((int)data_unkNamcoGamepad_800842DC + iVar9) + (iVar12 * 200) / 0x5000 + 0x100) * 0x10000 >> 0x10),(short)(((uint)*(ushort *)((int)data_unkNamcoGamepad_800842DC + iVar9 + 2) + (uint)(ushort)sdata_unk_drawingRaceWheelRects[1] + (iVar6 * 0x19 >> 0xc)) * 0x10000 >> 0x10),10,0x80,sVar1,(char *)(data_unkNamcoGamepadRwdTriangleColors + iVar9),(u_long *)(sdata_gGT->tileView_UI).ptrOT,&sdata_gGT->backBuffer->primMem);
			iVar9 = iVar8 + 1;
...
LAB_8003892c:
			...
			if (iVar6 < 0)
	{
			...
			CTR_Box_DrawWirePrims((u_short)((uint)(((iVar10 >> 6) + 0x100) * 0x10000) >> 0x10),(u_short)(((uint)(ushort)sdata_unk_drawingRaceWheelRects[1] + (iVar8 * 0x28 >> 0xc)) * 0x10000 >> 0x10),(u_short)((uint)(((iVar6 * 0x120) / 0x5000 + 0x100) * 0x10000) >> 0x10),(u_short)(((uint)(ushort)sdata_unk_drawingRaceWheelRects[1] + (iVar8 * 0x24 >> 0xc)) * 0x10000 >> 0x10),red,red,red,(sdata_gGT->tileView_UI).ptrOT,&sdata_gGT->backBuffer->primMem);
			iVar12 = iVar12 + 0x400;
			iVar6 = iVar9 + 0xaa;
		...
		do
	{
			...
			MainFreeze_ConfigDrawNPC105(*(short *)((int)data_unkNamcoGamepad_800842DC + iVar6 + 0x24) * sVar2 + 0x100,(ushort)sdata_unk_drawingRaceWheelRects[1] + *(short *)((int)data_unkNamcoGamepad_800842DC + iVar6 + 0x26) * sVar2,*(short *)((int)data_unkNamcoGamepad_800842DC + iVar9 + 0xc),0x80,sVar1,(char *)((int)data_unkNamcoGamepad_800842DC + iVar6 + 0x18),(u_long *)(sdata_gGT->tileView_UI).ptrOT,&sdata_gGT->backBuffer->primMem);
			iVar12 = iVar12 + 1;
...
LAB_80038b24:
	MENUBOX_DrawInnerRect(r,4,(u_long *)(sdata_gGT->tileView_UI).ptrOT);
	return;
}