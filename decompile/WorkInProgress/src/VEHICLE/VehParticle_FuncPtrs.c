...
void VehParticle_Sparks_Ground(struct Driver *d, struct ParticleEmitter *emSet)
{
    int iVar4;
    int iVar5;
    int iVar6;
...
void VehParticle_Terrain_Ground(struct Driver *d, struct ParticleEmitter *emSet)
{
    int speed;
    char numTires;
    int velX;
...
void VehParticle_Sparks_Wall(struct Driver *d, struct ParticleEmitter *emSet)
{
    int speed;
    u_int uVar1;
    u_int uVar2;
