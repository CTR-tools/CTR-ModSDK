        ...
        else
        {
          ...
          for (i = 0; i < 4; i++)
          {
                ...
                gGT->finishedRankOfEachTeam[driver->BattleHUD.teamID] == 0)
            {
              ...
              gGT->tileView[gGT->winnerIndex[gGT->numWinners]].fadeFromBlack_currentValue = 0x1fff;
              gGT->tileView[gGT->winnerIndex[gGT->numWinners]].fadeFromBlack_desiredResult = 0x1000;
              gGT->tileView[gGT->winnerIndex[gGT->numWinners]].fade_step = 0xff78;
