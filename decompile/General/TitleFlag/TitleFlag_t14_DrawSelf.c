...
LAB_80044568:
  ...
  *(u_char2 *)(puVar27 + 0x12) = 0xfc72;
  sVar2 = *(short *)(puVar26 + 0x4d8);
  *(u_char2 *)(puVar27 + 0x1a) = 0xfcd0;
  *(u_char2 *)(puVar27 + 0x22) = 0xfd2e;
  sVar2 = -0xbbe - sVar2;
  ...
  *(short *)(puVar27 + 0x20) = sVar2;
  ...
  iVar5 = 1;
  puVar22 = &data.trigApprox[0];
  uVar16 = 0x80008000;
  iVar24 = *(int *)(puVar27 + 0x48);
  *(u_char **)(puVar27 + 0x50) = puVar27 + 0x48;
  *(u_char **)(puVar27 + 0x5c) = puVar27 + 0x10;
  iVar28 = 0xd80200;
  *(uint *)(puVar27 + 0x28) = data.checkerFlagVariables[0];
  *(int *)(puVar27 + 0x2c) = data.checkerFlagVariables[1];
  *(uint *)(puVar27 + 0x30) = data.checkerFlagVariables[2];
  *(int *)(puVar27 + 0x34) = data.checkerFlagVariables[3];
  *(uint *)(puVar27 + 0x38) = data.checkerFlagVariables[4];
  do {
    puVar21 = (uint *)(uVar25 * 0x78 + 0x1f7ffffc);
    uVar25 = uVar25 ^ 1;
    puVar23 = (uint *)(uVar25 * 0x78 + 0x1f800000);
    uVar19 = *(int *)(puVar27 + 0x4c) + 0x100;
    uVar18 = *(int *)(puVar27 + 0x38) + *(int *)(puVar27 + 0x34) * 0x40;
    uVar10 = (int)uVar18 >> 5;
    *(uint *)(puVar27 + 0x4c) = uVar19;
    *(uint *)(puVar27 + 0x38) = uVar18;
    if (0xfff < uVar10) {
      uVar10 = (int)(uVar18 & 0x1ffff) >> 5;
      *(uint *)(puVar27 + 0x38) = uVar18 & 0x1ffff;
      uVar18 = *(int *)(puVar27 + 0x28) + 0x200;
      *(uint *)(puVar27 + 0x28) = uVar18;
    ...
    do {
      if (iVar7 < 0xb) {
        ...
        if (iVar7 < 10) {
          ...
          *(short *)(puVar27 + 0x22) = *(short *)(puVar27 + 0x22) + 0x11a;
          *(short *)(puVar27 + 0x1a) = *(short *)(puVar27 + 0x1a) + 0x11a;
          gte_ldv3(*(SVECTOR **)(puVar27 + 0x5c),(SVECTOR *)(puVar27 + 0x18),
                   (SVECTOR *)(puVar27 + 0x20));
          gte_rtpt();
        }
      }
      if (iVar15 == 0) {
      ...
      *(int *)(puVar27 + 0x58) = iVar24 * 0x69 + (0x2000 - iVar24) * 0xa0 >> 0xd;
      do {
        if (((*puVar23 & puVar23[1] & uVar16 & uVar16 & *puVar21 & uVar16 & puVar21[1]) == 0) &&
          ...
          puVar20[4] = *puVar21;
          puVar20[8] = puVar21[1];
          uVar10 = (uint)(byte)puVar27[0x40];
          uVar10 = uVar10 | uVar10 << 0x10 | uVar10 << 8;
          puVar20[1] = uVar10;
          puVar20[5] = uVar10;
          uVar10 = (uint)(byte)puVar27[0x41];
          ...
          *puVar3 = *puVar3 & 0xff000000 | (uint)puVar20 & 0xffffff;
        }
        puVar23 = puVar23 + 1;
        puVar21 = puVar21 + 1;
        uVar18 = uVar18 + 1;
