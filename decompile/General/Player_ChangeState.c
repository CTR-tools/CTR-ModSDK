...
void DECOMP_VehPtr_Spinning_Init();
void DECOMP_VehPtr_Blasted_Init();

int DECOMP_Player_ChangeState(
...
VictimLaugh:
	...
	else if(damageType == 2)
	{
		...
		// quit if already blasted
		if(victimDriver->funcPtrs[0] == DECOMP_VehPtr_Blasted_Init)
			return 0;
		
		victimDriver->funcPtrs[0] = DECOMP_VehPtr_Blasted_Init;
	...
	else //if(damageType == 5)
	{
		...
		victimDriver->funcPtrs[0] = VehPtr_EatenByPlant_Init;
