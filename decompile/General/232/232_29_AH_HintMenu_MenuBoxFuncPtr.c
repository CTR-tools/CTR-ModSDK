...
LAB_800b38cc:
    ...
    if (D232.hintMenu_scrollIndex + 5 <= mb->rowSelected)
    {
        D232.hintMenu_scrollIndex = mb->rowSelected - 4;
    }
    if (mb->rowSelected < D232.hintMenu_scrollIndex)
    {
        D232.hintMenu_scrollIndex = mb->rowSelected;
    }
    sVar12 = 5;
