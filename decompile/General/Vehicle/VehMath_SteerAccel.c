	...
	int param_4, int param_5, int param_6)
{
  ...
  if (param_1 < param_2) 
  {
    ...
    param_6 = DECOMP_VehMath_MapToRange(param_1, 0,param_2, param_5,param_6);
  }
  ...
  else 
  {
    ...
    if (param_2 + param_3 < param_1) 
	{
      ...
      param_6 = DECOMP_VehMath_MapToRange(param_1, param_2 + param_3,param_4, param_6,0);
    }
  }
