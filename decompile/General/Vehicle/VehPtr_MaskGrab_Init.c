...
void DECOMP_VehPtr_MaskGrab_Init(struct Thread* t, struct Driver *d)
{
...
{
    NULL,
    DECOMP_VehPtr_MaskGrab_Update,
    DECOMP_VehPtr_MaskGrab_PhysLinear,
    ...
    OnRender,
    DECOMP_VehPtr_MaskGrab_Animate,
