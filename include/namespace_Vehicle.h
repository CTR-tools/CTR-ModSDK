...
enum Items
{
	...
	ITEM_3X_BOMB = 10,
	ITEM_3X_MISSILE = 11,
	ITEM_INVISIBILITY = 12,
	ITEM_SUPER_ENGINE = 13,
	// UNUSED ITEM SLOT
	ITEM_NONE = 15,
	ITEM_ROULLETE = 16
};
...
enum Actions
{
	...
	ACTION_TOUCH_WALL	   =	    0x200,
	ACTION_SKID_BACKWHEEL  =        0x800,
	ACTION_SKID_FRONTWHEEL =	   0x1000,
	ACTION_WARP 		   =       0x4000,
	ACTION_ECHO_ENGINE     =	  0x10000,
	ACTION_STOP_CLOCK      =	  0x40000,
