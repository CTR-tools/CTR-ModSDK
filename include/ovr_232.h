#define PRIZE_TROPHY_RACE 6
#define PRIZE_BOSS_KEY 0x5e
#define PRIZE_TOKEN_RACE 0x4c
#define PRIZE_RELIC_RACE 0x16
#define PRIZE_CRYSTAL_CH 0x6f
#define PRIZE_GEM_CUP 0x6a
#define PRIZE_PLATINUM 0x3a
#define PRIZE_GOLD 0x28
