...
// param9 (sp+0x20) - lev->0x44
	 ...
	 // 1f8000dc = P1 camera110
	 // 1f8000e0 = P2 camera110
	 // 1f8000e4 = P3 camera110
	 // 1f8000e8 = P4 camera110
	 ...
	 // delay slot: a1 = 1f8000dc (P1 camera110)
	 ...
	 // call PrepareDraw (set camera matrix, window dimensions, etc)
	 // delay slot: a1 = 1f8000e0 (P2 camera110)
	 ...
	 // call PrepareDraw (set camera matrix, window dimensions, etc)
	 // delay slot: a1 = 1f8000e4 (P3 camera110)
	 ...
	 // call PrepareDraw (set camera matrix, window dimensions, etc)
	 // delay slot: a1 = 1f8000e8 (P4 camera110)
	...
	// FUN_800a106c: Get JR, and Run CopyMeta loops
	 ...
	 // camera110 offset 0x28, store entire matrix on GTE
	 ...
	 // camera110 0xC - 0x12, frustum data
	 ...
	 // camera110 matrix offset 0x28, upload to GTE
