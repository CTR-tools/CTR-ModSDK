...
REM Delete possible _disabled files from 3DFM/HelixVision
del nvwgf2umx_disabled.dll
del d3d11_disabled.dll

REM Delete any new geo-11 DM files and folders
del d3dxdm.ini

rmdir /s /q DMAutoPatchCache
rmdir /s /q DMAutoPatchFailures
