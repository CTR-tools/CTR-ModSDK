...
sliding, and blue fire! Made by Redhot. For US and PAL, it includes custom
graphics for the title screen and start flags made by Avery and LinkZer.

*Doesn't include stilted physics, automated jumps, "propietary code takeovers",
or polswid.

This mod also automatically enables the cheat code to turn every turbo pad into
a "blue fire" turbo pad.
