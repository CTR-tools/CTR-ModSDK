...
struct LevelFile file =
{
	...
	.levVertex =
	{
		...
		[0+9*4] =
		{
			.pos = {-0x180+0x300*3,0,-0x180+0x180*1},
			.flags = 0,
			.color_hi = {0xCE, 0x8F, 0x77, 0x00},
			.color_lo = {0xCE, 0x8F, 0x77, 0x00},
		},
		...
		[0+9*5] =
		{
			.pos = {-0x180+0x300*3,0,-0x180+0x180*2},
			.flags = 0,
			.color_hi = {0xCE, 0x8F, 0x77, 0x00},
			.color_lo = {0xCE, 0x8F, 0x77, 0x00},
		},
		...
		[0+9*6] =
		{
			.pos = {-0x180+0x300*3,0,-0x180+0x180*3},
			.flags = 0,
			.color_hi = {0xCE, 0x8F, 0x77, 0x00},
			.color_lo = {0xCE, 0x8F, 0x77, 0x00},
		},
