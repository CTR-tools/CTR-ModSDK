...
void DECOMP_DecalHUD_DrawWeapon(struct Icon* icon, u_int posX, int posY, struct PrimMem* primMem, u_int* ot, u_char semitransparencyEnabled, short scale, u_short param_8)
{
	u_int uVar1;
	u_int bitshiftPosY;
	u_int uVar3;
