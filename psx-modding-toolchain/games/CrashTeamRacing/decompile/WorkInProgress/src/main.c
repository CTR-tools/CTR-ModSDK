		...
		switch(sdata.mainGameState)
		{
			...
			case 0:
				...
				*(u_int*)&sdata.gGT->battleSetup.teamOfEachPlayer = 0x3020100;
				...
				GAMEPAD_Init(sdata.PtrGamepadSystem);

				VSync(0);

				GAMEPAD_GetNumConnected(sdata.PtrGamepadSystem);
			...
			case 3:
				...
				GAMEPAD_UpdateAll(sdata.PtrGamepadSystem);

				// Start new frame (ClearOTagR)
				StartNewFrame(sdata.gGT, sdata.PtrGamepadSystem);
				...
				)
				{
					...
					else
					{
						...
						if (*(int *)(sdata.PtrGamepadSystem + 0x290) != 0)
						{
							// leave demo mode
							sdata.gGT->boolDemoMode = 0;
							goto LAB_8003ce08;
				...
				{
					GameplayUpdateLoop(sdata.gGT, sdata.PtrGamepadSystem);
				}
				...
				RenderFrame(sdata.gGT, sdata.PtrGamepadSystem);
			...
			case 4:
				...
				GAMEPAD_SetMainMode(sdata.PtrGamepadSystem);
