...
struct MenuRow UDCTRM_ED_MenuRows[] =
{
    ...
    MENU_ROW(ROW_SUPER_HARD, 607, ROW_HARD, ROW_ULTRA_HARD, ROW_SUPER_HARD, ROW_SUPER_HARD),
    MENU_ROW(ROW_ULTRA_HARD, 608, ROW_SUPER_HARD, ROW_ULTRA_HARD, ROW_ULTRA_HARD, ROW_ULTRA_HARD),
    FINALIZER_ROW
};
